        ...
        for itype in itypenames:
            ...
            if mask.any():
                ...
                if ratioflag:
                    ...
                    handle = ax[dety, detx].errorbar(energy, ratio, xerr=xerr, yerr=ratio_err, fmt='-',alpha=0.3)
                    ...
                    handle = ax[dety, detx].errorbar(energy, ncount, xerr=xerr, yerr=yerr, fmt='-',alpha=0.3)
