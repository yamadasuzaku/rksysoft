...
#target_date = datetime.datetime.strptime("20240313", '%Y%m%d')
#target_date = datetime.datetime.strptime("20240721", '%Y%m%d')
target_date = datetime.datetime.strptime("20240812", '%Y%m%d')
#target_date = datetime.datetime.strptime("20240526", '%Y%m%d')
#target_date = datetime.datetime.strptime("20240506", '%Y%m%d')
#target_date = datetime.datetime.strptime("20240227", '%Y%m%d')
#target_date = datetime.datetime.strptime("20240217", '%Y%m%d')
...
def cut_flist(flist):
    ...
    for file in flist:
        # ファイル名の日付部分だけを取得
        print("file = ", file)
        file_date_str = file[12+10:20+10]
...
#directory_path = "/data7/operation/qlff/"
directory_path = "./"
...
#sorted_file_paths = sorted(file_paths, key=lambda x: x.split('/')[4])
...
for i, onef in enumerate(file_paths):
